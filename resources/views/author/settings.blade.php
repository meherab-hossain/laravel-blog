                    ...
                    <div class="body">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade in active" id="profile_with_icon_title">
                                <form  action="{{route('author.profile.update')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row clearfix">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="email" id="email_address" class="form-control" placeholder="Enter your email address" name="email" value="{{Auth::user()->email}}">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                            <textarea rows="5" id="about"  name="about" class="form-control">
                                                {{Auth::user()->about}}
                                            </textarea>
                                                </div>
                                            </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="change_password_with_icon_title">
                                <form  action="{{route('author.password.update')}}" class="form-horizontal" method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="row clearfix">
